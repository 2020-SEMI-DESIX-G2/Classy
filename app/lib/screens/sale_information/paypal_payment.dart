import 'dart:core';
import 'package:classy/screens/sale_information/paypal.dart';
...
class PaypalPaymentState extends State<PaypalPayment> {
  ...
  String itemName = 'Camiseta cropped con botones';
  String itemPrice = '31.99';
  int quantity = 1;
  ...
  Map<String, dynamic> getOrderParams() {
    ...
    String totalAmount = '31.99';
    String subTotalAmount = '31.99';
